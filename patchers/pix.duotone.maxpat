        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 292.0, 420.0, 87.0, 22.0 ],
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 227.0, 269.0, 87.0, 22.0 ],
                                    "text": "param curve 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 150.0, 315.0, 52.0, 22.0 ],
                                    "text": "fastpow"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 210.0, 30.0, 147.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 30.0, 270.0, 111.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 30.0, 360.0, 139.0, 22.0 ],
                                    "text": "mix"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 210.0, 120.0, 44.0, 22.0 ],
                                    "text": "swiz g"
                                }
                            },
                            {
                    ...
                    "patching_rect": [ 154.75, 466.0, 129.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 360.0, 60.0, 200.0, 49.0 ],
                    "text": "patcherargs 1 @color1 0. 0.382812 0.875 @color2 0.820312 0.5 1. @curve 0.5 @filter linear"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 255.75, 240.0, 55.0, 22.0 ],
                    "text": "curve $1"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 550.5, 114.5, 193.25, 114.5 ],
                    "source": [ "obj-20", 1 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-23", 0 ],
                    "midpoints": [ 315.5, 355.05859375, 353.21875, 355.05859375, 353.21875, 125.0, 193.25, 125.0 ],
                    "source": [ "obj-26", 3 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-8", 0 ],
                    "midpoints": [ 281.5, 347.0, 340.5, 347.0, 340.5, 124.0, 369.5, 124.0 ],
                    "source": [ "obj-26", 2 ]
                }
            },
            {
