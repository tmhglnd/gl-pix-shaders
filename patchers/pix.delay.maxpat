...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 108.5, 195.0, 19.0, 22.0 ],
					"text" : "t i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 142.0, 195.0, 19.0, 22.0 ],
					"text" : "t i"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 300.0, 91.0, 22.0 ],
									"text" : "texturecount $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 300.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 255.0, 137.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 150.0, 300.0, 54.0, 22.0 ],
									"text" : "index $1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 73.0, 90.0, 40.0, 22.0 ],
									"text" : "t b l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_gl_texture" ],
									"patching_rect" : [ 83.5, 360.0, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.5, 422.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 75.0, 375.0, 86.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 189.0, 120.0, 51.0, 22.0 ],
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 189.0, 45.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 189.0, 75.0, 105.0, 22.0 ],
					"text" : "patcherargs 30 60"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(int) delaytime",
					"cool" : 1,
					"id" : "obj-6",
					"index" : 2,
					"maxclass" : "inlet",
